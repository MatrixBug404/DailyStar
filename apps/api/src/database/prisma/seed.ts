...
async function main() {
  ...
  const permissionsData = [
    ...
    { name: 'article.revision.create.own', description: 'Can create a new revision on own article' },
  ...
  const rolesData = [
    {
      ...
      permissions: [
        'user:read', 'article:create', 'article:read', 'article:edit',
        'article.create', 'article.read.own', 'article.update.own', 'article.delete.own', 'article.revision.create.own',
    ...
    },
    {
      ...
      permissions: [
        'user:read', 'article:create', 'article:read', 'article:edit', 'article:delete',
        'article.create', 'article.read.any', 'article.update.any', 'article.revision.create.any', 'category.manage', 'tag.manage',
        'article.submit-review', 'article.start-review', 'article.request-changes', 'article.reject', 'article.approve', 'article.publish', 'article.schedule', 'article.cancel-schedule', 'article.archive'
      ],
    },
    {
      name: 'admin',
      ...
      permissions: [
        ...
        'article:create', 'article:read', 'article:edit', 'article:delete',
        'article.create', 'article.read.any', 'article.update.any', 'article.delete.any', 'article.revision.create.any', 'category.manage', 'tag.manage',
        'article.submit-review', 'article.start-review', 'article.request-changes', 'article.reject', 'article.approve', 'article.publish', 'article.schedule', 'article.cancel-schedule', 'article.archive'
      ],
    },
  ];
